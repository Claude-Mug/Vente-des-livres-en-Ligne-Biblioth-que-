...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['livres']) && isset($_POST['numero'])) {
        $livres = $_POST['livres']; // Liste des livres sélectionnés
        $numero = $_POST['numero']; // Numéro de téléphone sélectionné
...
<body>
<div class="container">
    <h1 class="mt-4">Payer par mobile</h1>
    ...
    <form method="POST" action="">
        ...
        <div class="form-group">
            <label for="numero">Choisissez un numéro de téléphone :</label>
            <select class="form-control" id="numero" name="numero" required>
                <option value="+243810000000">Airtel RDC: +243 810 000 000</option>
                <option value="+257790000000">Limutel Burundi: +257 790 000 000</option>
                <option value="+257791000000">Limutel Burundi: +257 791 000 000</option>
                <option value="+257792000000">Limutel Burundi: +257 792 000 000</option>
            </select>
        </div>
